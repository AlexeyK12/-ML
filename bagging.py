...
class SimplifiedBaggingRegressor:
    ...
    def _get_averaged_oob_predictions(self):
        ...
        self.oob_predictions = [np.mean(predictions) if len(predictions) > 0 else None for predictions in
    ...
    def OOB_score(self):
        ...
        squared_errors = (self.target[valid_indices] - np.array(self.oob_predictions)[valid_indices]) ** 2
